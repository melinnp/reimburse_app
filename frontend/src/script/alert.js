...
export function showAlert(type, message) {
  ...
  if (!alertBox) {
    ...
    alertBox.className = 'mx-3 mt-3';
    const app = document.getElementById('app');
    if (app) {
      const mainContent = app.querySelector('.main-content') || app.querySelector('main') || app;
 ...
 */
export function showConfirmAlert(title, message, confirmText = 'Ya, Lanjutkan', cancelText = 'Batal', type = 'warning') {
